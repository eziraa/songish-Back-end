...
urlpatterns = [
    ...
    path('user/<int:user_id>/add_favorite/<int:song_id>',
         add_song_to_favorite, name='add_favorite'),
    path('user/<int:user_id>/songs/',
         get_your_favorite_songs, name='get_favorite_songs'),
    path('user/<int:user_id>/my-songs/',
         get_my_songs, name='get_my_songs'),
    path('songs/<int:user_id>/remove_song/<int:song_id>',
         remove_song_from_favorite, name='remove_song_from_favorite_songs'),
